...
class HomeP:
    def __init__(self, master):
        ...
        self.button1 = Label(self.frame2, font="40", text="Home", bg="#9933ff")
        self.button2 = Button(self.frame2, font="40", text="Shop", bg="#a64dff", command=ref)
        self.button3 = Button(self.frame2, font="40", text="bill", bg="#a64dff", command=ref1)
        ...
        self.button1.pack(side=LEFT, padx=200)
        self.button2.pack(side=LEFT, padx=200)
        self.button3.pack(side=LEFT, padx=200)
